        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="relative order-first lg:order-last">
              <img
                src="/indian-family-therapy-support.jpg"
                alt="Indian family with developmental disabilities support"
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-card">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
            ...
            <div className="w-full lg:w-1/2">
              <h2 className="text-2xl sm:3xl md:text-4xl font-bold text-foreground mb-6 sm:mb-8">
                Soultrove at a glance
              </h2>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-secondary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
            ...
            <div className="w-full lg:w-1/2">
              <h2 className="text-2xl sm:3xl md:text-4xl font-bold text-foreground mb-8">Mission – Vision - Goal</h2>

              <div className="space-y-8">
                {/* Mission */}
                <div>
                  <h3 className="text-xl sm:text-2xl font-semibold text-foreground mb-3">Mission</h3>
                  <p className="text-base sm:text-lg text-secondary-foreground leading-relaxed">
                    To empower individuals with developmental disabilities and their families at every stage of life —
                    from diagnosis to adulthood and beyond — through compassionate access to care, inclusive
                    opportunities, and sustainable planning for the future.
                  </p>
                </div>

                {/* Vision */}
                <div>
                  <h3 className="text-xl sm:text-2xl font-semibold text-foreground mb-3">Vision</h3>
                  <p className="text-base sm:text-lg text-secondary-foreground leading-relaxed">
                    A world where every person with a developmental disability can live a life of dignity, independence,
                    and purpose — supported by a connected ecosystem that grows with them across their life journey.
                  </p>
                </div>

                {/* Goal */}
                <div>
                  <h3 className="text-xl sm:text-2xl font-semibold text-foreground mb-3">Goal</h3>
                  <p className="text-base sm:text-lg text-secondary-foreground leading-relaxed">
                    To become the most trusted, life-span-focused digital ecosystem for developmental disabilities —
                    integrating care, education, skills, employment, and long-term planning — so that no family ever
                    walks this path alone.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="w-full lg:w-1/2">
              <img
                src="/therapist-patient-session.jpg"
                alt="Therapist working with patient with developmental disabilities"
                className="rounded-lg shadow-lg w-full h-auto"
              />
            </div>
          </div>
